  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <aside
        style={{
          width: "240px",
          background: "linear-gradient(180deg, #111827, #1f2937, #020617)",
          color: "#ffffff",
          padding: "20px",
        }}
      >
        ...
        <nav style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <Link style={linkStyle} to="#">Manage Users</Link>
          <Link style={linkStyle} to="#">Classes</Link>
          <Link style={linkStyle} to="#">Attendance</Link>
          <Link style={linkStyle} to="#">Reports</Link>
        </nav>
      </aside>
